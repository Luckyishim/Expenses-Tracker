  ...
  return (
    <main className="create-account-page">
      <header className="create-brand">
          <div className="brand-line">
            <svg aria-hidden="true" viewBox="0 0 30 30">
              <path d="M5 4.5h15.5a2.5 2.5 0 0 1 2.5 2.5v16a2.5 2.5 0 0 1-2.5 2.5H8a3 3 0 0 1-3-3V7.5A3 3 0 0 1 8 4.5Z" />
              <path d="M10 10h8v8h-8zM14 14h5" />
            </svg>
            <h1>Money Tracker</h1>
          </div>
      ...
      <section
        ...
        // aria-label="Create a Money Tracker account"
      >
